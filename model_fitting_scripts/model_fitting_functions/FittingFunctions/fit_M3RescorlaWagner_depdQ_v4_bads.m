...
function [best_Xfit, best_LL, best_BIC] = fit_M3RescorlaWagner_depdQ_v4_bads(resp_vec,reward_vec, n_start_pts)

obFunc = @(x) lik_M3RescorlaWagner_depdQ_v4(resp_vec, reward_vec, x(1), x(2));
